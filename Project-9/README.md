...
Time bases are off now, so the SW ought to be modified. Hence values on the LCD are not correct, an implemented second counter counts too fast (i. e. 14.31/12.00 too fast).
