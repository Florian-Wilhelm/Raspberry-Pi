/**
 * Created 26/11/2023 by Florian Wilhelm Dirnberger
 *
 * Playing around with and exploring the RP2040 Clocks, so this code is mostly a quick&dirty construct
...
int main() {
    ...
    /*uint32_t *PLL = (uint32_t *)0x40028000; // PLL_BASE
    
    *(PLL + 0xc / 4) = 0x00020000;*/
    ...
    *(ROSC + 0x00 / 4) = 0x00fabfa5; // ROSC control
