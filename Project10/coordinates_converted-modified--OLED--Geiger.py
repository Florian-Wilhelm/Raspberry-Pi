...
while True:
  if trigger.value() == 0: # ad-hoc solution using polling and an extra wire: when the device starts to transmit it pulls the line low to generate an UART start bit, that is exploited here 
    #print('CPM:')
