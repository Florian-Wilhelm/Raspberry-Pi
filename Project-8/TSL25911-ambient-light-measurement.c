/**
 * 
 * TSL25911 ambient light sensor test code as of March 21, 2026
 * 
...
#define TSL25911_I2C_ADRESS _u(0x29)
...
void TSL25911_WriteInitI2C(uint8_t command[], uint32_t* length){
...
{  
    ...
    */
    ...
    TSL25911_WriteInitI2C(TSL25911_init, &length);
    ...
    while(true){ 
      ...
      // Acquiring the actual TSL25911 ambient light data; can be written shorter with a function though, but who cares
     
      uint8_t TSL25911_LB_CH0[] = {0xB4};    
    
      i2c_write_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_LB_CH0, length, false);   
      i2c_read_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_LB_CH0, length, false);
      
      uint8_t TSL25911_HB_CH0[] = {0xB5};
    
      i2c_write_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_HB_CH0, length, false);    
      i2c_read_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_HB_CH0, length, false);   
            
      uint8_t TSL25911_LB_CH1[] = {0xB6};    
    
      i2c_write_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_LB_CH1, length, false);    
      i2c_read_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_LB_CH1, length, false);
      
      uint8_t TSL25911_HB_CH1[] = {0xB7};
    
      i2c_write_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_HB_CH1, length, false);    
      i2c_read_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_HB_CH1, length, false); 
      
      uint8_t TSL25911_STATUS[] = {0xB3};
    
      i2c_write_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_STATUS, length, false);    
      i2c_read_blocking(I2C_ID, TSL25911_I2C_ADRESS, TSL25911_STATUS, length, false);   
