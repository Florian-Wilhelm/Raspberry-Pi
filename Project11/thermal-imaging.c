/**
 * 
 * Test code as of September 18 2025, not yet to be used
 * 
...
{  
    ...
    */ 
    ...
    while(true){
      ...
      for (int i=ImageDataStartAddress; i <= ImageDataStartAddress; i++) 
          ...
          {   
           ...
           if (decimalValueTemperature > 30)
              renderImage(0, 47, 52, 2, 2); 
           else 
              renderImage(1, 47, 52, 2, 2); 
