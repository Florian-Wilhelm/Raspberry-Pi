/**
 * 
 * Test code as of September 23, 2025, created by FWD
 * 
 ...
 * in the long run, prototypes are intended being part of an IoT environment
 *  
 */
...
// OLED SSD1306 just for early prototypes, for it has no colors
#include "oled.h"
...
{  
    ...
    */ 
    ...
    // yet do be implemented, using default values 
    ...
    sleep_ms(1);
     ...
     // test I2C commands for TSL25911
      ...
      uint16_t thresholdUp = 32; // Temperature
      uint16_t thresholdDown = 28; // Temperature
      ...
      while(true){   
           ...
           { 
             ...
             if (i == 1)
               pixelAddress = 0x342C; // first pixel at row 1
           ...
           { 
             ...
             if (i == 1)
               pixelAddress = 0x34CC; // experimental value, some pixel in the middle rows
           ...
           { 
             ...
             if (i == 1)
               pixelAddress = 0x396C; // experimental value, some pixel in the middle rows
           ...
           { 
             ...
             if (i == 1)
               pixelAddress = 0x3A0C; // first pixel at row 24 (?)
