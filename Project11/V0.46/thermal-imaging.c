/**
 * 
 * Test code as of October 10, 2025, created by FWD
 * 
...
uint16_t thresholdUp; 
uint16_t thresholdDown;

uint16_t decimalValueTemperatureRow1[15]; 
uint16_t decimalValueTemperatureRow2[15]; 
uint16_t decimalValueTemperatureRow3[15]; 
uint16_t decimalValueTemperatureRow4[15]; 
     ...
     // test I2C commands for TSL25911
      ...
      while(true){   
           ...
           { 
             ...
             decimalValueTemperatureRow1[i-1] = ((pixelValue[0] << 8) + pixelValue[1]) / 50;  // see data sheet for the formula     
           ...
           { 
             ...
             decimalValueTemperatureRow2[i-1] = ((pixelValue[0] << 8) + pixelValue[1]) / 50;  // see data sheet for the formula     
           ...
           { 
             ...
             decimalValueTemperatureRow3[i-1] = ((pixelValue[0] << 8) + pixelValue[1]) / 50;  // see data sheet for the formula     
           ...
           { 
             ...
             decimalValueTemperatureRow4[i-1] = ((pixelValue[0] << 8) + pixelValue[1]) / 50;      
