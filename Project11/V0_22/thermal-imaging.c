/**
 * 
 * Test code as of September 22, 2025
 * 
 * MLX90642 IR array serves as main sensor
 * TSL25911 ambient light sensor is an additional component to stress the I2C a bit 
 * 
 * OLED for thermal display, some data output on the serial port; in the long run, prototypes are intended being part of an IoT environment
 *  
 */
    ...
    */ 
    ...
    sleep_ms(1);
     ...
     // test I2C commands for TSL25911
      ...
      uint16_t thresholdUp = 30;
      uint16_t thresholdDown = 28;
