 ...
 * -modified 19/02/2026 -> making WiFi credentials (SSID, PASS) accessible via Picotool
 *
...
int main()
{
    ...
    */  
    ...
    #define BI_MY_TAG   BINARY_INFO_MAKE_TAG('N','P')
    #define BI_MY_ID    0x1111
   
    bi_decl(bi_program_feature_group_with_flags(BI_MY_TAG, BI_MY_ID, "Data", BI_NAMED_GROUP_SEPARATE_COMMAS | BI_NAMED_GROUP_SORT_ALPHA));
   
    bi_decl(bi_ptr_string (BI_MY_TAG, 0, SSID, "WiFi-123", 256));
    bi_decl(bi_ptr_string (BI_MY_TAG, 0, PASS, "12345", 256));
