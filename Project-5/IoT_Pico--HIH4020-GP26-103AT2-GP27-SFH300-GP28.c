/**
 * Created 19/09/2022 by Florian Wilhelm Dirnberger; modified 09/08/2023 (watchdog implementation)
 *
...
int WDCounter __attribute__((section(".unitialized_data1")));
int hitCounter __attribute__((section(".unitialized_data2")));
