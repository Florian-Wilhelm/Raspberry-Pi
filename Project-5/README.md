...
An IoT device comprising a Raspberry Pi Pico, three sensors (including HIH4020) and the ESP8266. Note: no SSL/TLS is or will be implemented (i.e. certificates), so you'll get only a HTTP connection, thus code is only meant for experimental use.
