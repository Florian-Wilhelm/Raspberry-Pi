/**
 * Created 15/01/2023 by Florian Wilhelm Dirnberger
 *
...
// this is not necessarily an optimized calculation for generating one particular duty cycle, but it works sufficiently for the given purpose
