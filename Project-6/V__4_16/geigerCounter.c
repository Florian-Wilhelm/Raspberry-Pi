/**
 * Created 15/02/2024 by Florian Wilhelm Dirnberger
 *
...
int main() {  
    ...
    */
    ...
    /*
    system clock settings; still work to du, e.g. diminishing sys_clk to save power (some problems as to clk_peri, i. e. establishing communication with the BLE module)
    */  
