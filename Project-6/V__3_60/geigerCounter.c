/**
 * Created 28/03/2023 by Florian Wilhelm Dirnberger
 *
...
int main() {  
    ...
    uint multiplier = 3;  // rather unclear what this parameter is really about, documentation left some question marks  
    ...
    uint32_t *ROSC = (uint32_t *)0x40060000;
    
    *(ROSC + 0x10 / 4) = 0x00000aa0; // see RP2040 data sheet, chapter 2.17
    
    /*uint32_t *CLK = (uint32_t *)0x40008000;
    
    *(CLK + 0x40 / 4) = 0x00000200;*/
