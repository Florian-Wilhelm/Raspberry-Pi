/**
 * Created 03/12/2022 by Florian Wilhelm Dirnberger
 *
 ...
 * 
 * note: Pull-up resistor is ENabled (push-pull mode) for the IRQ GP
 * 
 */
...
int main() {   
    ...
    pwm_set_freq_duty(slice_num, chan, PWM_FQ, 45); // a little play-around with the duty-cycle
