/**
 * Created 14/01/2023 by Florian Wilhelm Dirnberger
 *
 ...
 * 
 * important note: Pull-Up resistors are ENabled for the IRQ GP and for the I2C (though the used OLED has its own Pull-Ups)
 * 
 */
...
static uint8_t three[] = {0x00,0x22,0x63,0x49,0x49,0x7f,0x36,0x00}; // 51=3
static uint8_t four[] = {0x00,0x18,0x18,0x14,0x16,0x7f,0x7f,0x10}; // 52=4
static uint8_t five[] = {0x00,0x27,0x67,0x45,0x45,0x7d,0x39,0x00}; // 53=5
static uint8_t six[] = {0x00,0x3e,0x7f,0x49,0x49,0x7b,0x32,0x00}; // 54=6
static uint8_t seven[] = {0x00,0x03,0x03,0x79,0x7d,0x07,0x03,0x00}; // 55=7
static uint8_t eight[] = {0x00,0x36,0x7f,0x49,0x49,0x7f,0x36,0x00}; // 56=8
static uint8_t nine[] = {0x00,0x26,0x6f,0x49,0x49,0x7f,0x3e,0x00}; // 57=9
