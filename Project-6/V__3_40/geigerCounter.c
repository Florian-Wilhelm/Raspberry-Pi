/**
 * Created 07/02/2023 by Florian Wilhelm Dirnberger
 *
 ...
 *
 * The system clock is diminished to 6 MHz thru this SW in order to reduce the power consumption
 * 
...
int main() {  
    ...
    uint multiplier = 6;  // rather unclear what this parameter is about  
    ...
    *(ROSC + 0x10 / 4) = 0x00000aa0; // see RP2040 data sheet, chapter 2.17
    ...
    // not necessary for the function itself, but saves apparently a further few mA
    pll_deinit(pll_sys);    
