/*
 * Created 03/06/2022 by Florian Wilhelm Dirnberger
 *
 * For testing purposes with a DiP-Pi PIoT; still not working properly
 * 
 */
...
{   
    ...
    for(;;)   {
        ...
        char data[] = "HTTP/1.0 200 OK\r\nServer: Pico\r\nContent-type:text/html\r\n\r\n<html><head><title>Geiger</title></head><body><p>{\"CPM\":20, \"temperature\":23.5C}</p></body></html>\r\n";
...
int main()    
{
    ...
    //connectWiFi(buf, 512, "WLAN-ABC", "12345"); // home WiFi
    connectWiFi(buf, 512, "HUAWEI P20 lite", "12345"); // mobile WiFi hotspot
