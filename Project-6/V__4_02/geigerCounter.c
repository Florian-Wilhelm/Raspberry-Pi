/**
 * Created 25/02/2023 by Florian Wilhelm Dirnberger
 *
...
void enterBLE(uint cpm)
{
    ...
    uint8_t SendData5[] = "PS,11223344556677889900AABBCCDDEEFF\r"; //sets UUID of private service 
    ...
    */
    ...
    // this is a preliminary algorithm and just for presentation purposes
    if (cpm <= 50)
        sendValue = 10;
    ...
    // 0072 = handle; can be different after e.g. a factory reset and re-establishing the Service and Characteristic, respectively! Use "LS\r" to learn about the value
    ...
    uint8_t SendData9[] = "---\r";
    uart_write_blocking(UART_ID, SendData9, strlen(SendData9));
}
