/**
 * Created 08/01/2023 by Florian Wilhelm Dirnberger
 *
 ...
 * 
 * note: Pull-Up resistors are ENabled for the IRQ GP and for the I2C (external may be better for a robust design)
 * 
 */
 
 // this SW-version (will be displayed on the LCD):
 char SW_Version[5] = "V2.04";
